...
sys.path.append('/Users/administrator/Documents/GitHub/hippylib/applications/ad_diff/')
...
def D_op(ur_index, misfit, Gamma_z, FtQt):
    ...
    d, U, H, misfit = ComputeHessianEvalue(misfit, Vh, observation_times, ur_index, noise_std_dev, mesh, prior,
                                           simulation_times, wind_velocity, r, x)
...
def ComputeHessianEvalue(misfit, Vh, observation_times, ur_index, noise_std_dev, mesh, prior, simulation_times,
                         wind_velocity, r, x):
